 ...
 * UART_DEV(1) is use for communication between boards.<br>
 * UART_DEV(2) is not available.<br>
 * @{
 */
#define UART0_TXD   GPIO1  /*!< direct I/O pin for UART_DEV(0) TxD */
#define UART0_RXD   GPIO3  /*!< direct I/O pin for UART_DEV(0) RxD */

#define UART1_TXD   GPIO21  /*!< direct I/O pin for UART_DEV(1) TxD */
#define UART1_RXD   GPIO22  /*!< direct I/O pin for UART_DEV(1) RxD */
/** @} */
