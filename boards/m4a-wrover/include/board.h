...
/**
 * @name  Default DS18B20 GPIO pin definition
 *
 */
#define DS18B20_PIN           GPIO25      /*!< peripheral pin ds18 */

/**
 * @name Default soil moisture analog sensor GPIO pin definition
 * the read depends on resolution bit of this board
 *
 */
#define MS_HW360_PIN          GPIO34     /*!< moisture sensor peripheral */
