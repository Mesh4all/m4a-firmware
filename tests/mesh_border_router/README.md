# Mesh Border Router using automatic configuration


## Important
> This example was taken as reference from the `RIOT-OS` repository, concretely it's the `gnrc_border_router` example.
> Code and/or documentation can change in a near future.
