...
def check_global_params(params):
    ...
    if "organization" not in _params or not _params["organization"]:
        _params["organization"] = "Mesh4all <mesh4all.org>"
...
def prompt_global_params(params):
    ...
    _prompt_param(_params, "organization", "Organization", default="Mesh4all.org <mesh4all.org>")
